...
def Encrypt_Cesar(word,key):
    mot_chiffre = ""
    
    for letter in word:
        letter = (ord(letter) - 65) + int(key)
        letter = letter % 26
        letter = chr(letter+65)
        mot_chiffre = mot_chiffre + letter
    return mot_chiffre

def Decrypt_Cesar(word,key):
    mot_dechiffre = ""
    ...
    for letter in word:
        ...
        letter = letter % 26
        letter = chr(letter+65)
        mot_dechiffre = mot_dechiffre + letter
...
def EncryptVig(msg,key):
    ...
    for letter in msg:
        ...
        letter = (letter+(ord(letterKey)-65))%26
        if i == len(key)-1:         #To know if the entire key is used up
            i = 0
        else:
            i += 1        #If not, we add it by 1 to continue the iteration till it gets expired
        
        letter = chr(letter+65)        
        messageChiffre = messageChiffre + letter
            
    return messageChiffre
    

def DecryptVig(msg,key):
    messageDechiffre = ""
    i = 0
    ...
    for letter in msg:
        ...
        letter = chr(letter+65)
        messageDechiffre = messageDechiffre + letter
